package com.onnyth.onnythserver.profile.application.usecase;
...
@DisplayName("ProfileVoteUseCaseService")
class ProfileVoteUseCaseServiceTest {

    @Mock ProfileVoteRepository voteRepository;
    @Mock UserRepository userRepository;

    @InjectMocks ProfileVoteUseCaseService voteService;
