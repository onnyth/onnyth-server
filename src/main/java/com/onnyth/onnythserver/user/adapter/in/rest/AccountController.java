...
import com.onnyth.onnythserver.user.application.usecase.AccountDeletionUseCaseService;
...
public class AccountController {
    ...
    private final AccountDeletionUseCaseService accountDeletionUseCaseService;
    ...
    public ResponseEntity<Void> deleteAccount(@AuthenticationPrincipal Jwt jwt) {
        ...
        accountDeletionUseCaseService.deleteAccount(userId);
